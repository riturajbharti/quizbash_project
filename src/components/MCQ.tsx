...
const MCQ = ({game}: Props) => {
    ...
    // const [timeStarted,setTimeStarted] = React.useState<Date>(new Date());
    ...
    },[checkAnswer,toast,isChecking,game.questions.length,questionIndex,endGame])
    ...
    <div className="absolute flex flex-col top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 md:w-[80vw] max-w-4xl w-[90vw] pt-64 pb-32">
      ...
      {options.map((option, index) => {
          return (
            <Button
              key={index}
              variant={selectedChoice === index ? "special" : "outline"}
